...
client.on('message', message => { 
    ...
    .setFooter(`LP Bot`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
...
client.on('message', MEGA => { 
  ...
  msk:   'Welcome'
        ...
        if(MEGA.content.startsWith('-' + `set-wlc`)) {        
  ...
  ** ${'-'}set-wlc toggle **
  ** ${'-'}set-wlc set [Channel Name] **
  ** ${'-'}set-wlc msg [Welcome MEGA] **`) // ->set-wlc toggle - ->set-wlc set - ->set-wlc msg
        let state = args[0]
 ...
 ** ${'-'}set-wlc msg [Welcome MEGA] **`) // ->set-wlc toggle - ->set-wlc set - ->set-wlc msg
        ...
        if(!newch) return MEGA.reply(`${'-'}set-wlc set [Channel name]`)
